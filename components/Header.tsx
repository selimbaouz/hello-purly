    ...
    return (
        <header className={cn('p-4 text-center py-24 space-y-10 max-w-screen-xl mx-auto', "xl:space-y-12")}>
            ...
            <p className={cn("text-base font-regular")}>
                Economisez jusqu{"'"}à 1500L par an tout en profitant d{"'"}une hygiène parfaite, <br className={cn("hidden", "xl:block")} />parce que votre derrière mérite aussi un traitement VIP !
            </p>
            <ShimmerButton
            shimmerColor='#319795'>
                <GradientButton
